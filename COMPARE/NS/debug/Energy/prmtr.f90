...
double precision,parameter::     expo=2.718281828d0
double precision,parameter:: GasConst=8.3144621d0
double precision,parameter::MolarMass=28.96d0
double precision,parameter::  GasSpec=GasConst/MolarMass*1.d3
